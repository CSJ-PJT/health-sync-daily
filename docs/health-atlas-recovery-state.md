...
## 상태 스냅샷
- SUPABASE_STATUS: `not_verified` (GitHub/OCI 경로는 확인됨. Supabase CLI 미탐지)
- SUPABASE_LINK_STATUS: `not_checked`
...
- OCI_API_STATUS: `pending` (`oci` 및 Supabase CLI 미발견)
...
## 완료 Gate
- Gate 0~4: Git/remote baseline 및 Task/Gmail 복구 근거 수집 완료
- Gate 5 미완료: Git push/OCI API/Supabase/DB 실인증·배포 전 단계로 인계
