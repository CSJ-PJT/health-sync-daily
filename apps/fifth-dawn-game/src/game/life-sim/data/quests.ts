...
export const lifeSimQuestDefinitions: Record<LifeSimQuestId, LifeSimQuestDefinition> = {
  ...
  "mine-recon": {
    ...
    description: { ko: "정화 광산에 들어가 자원과 위험 요소를 확인하세요.", en: "Enter the purifier ruins and recover resources." },
    rewardText: { ko: "정화 등불 설계도", en: "Purity Lantern recipe" },
  },
  "repair-lantern": {
    id: "repair-lantern",
    title: { ko: "등불 복구", en: "Restore the Lantern" },
    description: { ko: "정화 등불을 제작해 정비공 도윤에게 보여 주세요.", en: "Craft a Purity Lantern and bring it to the mechanic." },
    rewardText: { ko: "공명 15 + 관계도 상승", en: "15 Resonance + relationship boost" },
  },
  "restore-bridge": {
    id: "restore-bridge",
    title: { ko: "무너진 통로", en: "Broken Passage" },
    description: { ko: "복구 키트를 제작해 농장 북쪽 통로를 복원하세요.", en: "Craft a bridge kit to restore the northern farm passage." },
